...
void display_menu(){
	...
	printf(" 4. Add end date one month\n");
	printf(" 5. Delete a member\n");
	printf(" 6. Find member whose contract expired\n");
	printf(" 7. Show member data\n");
	printf(" 8. Load a new data file\n");
	printf(" 9. Save to a data file\n");
	printf(" 10. Save as Report\n");
	printf(" 11. Sort\n");
	printf(" 12. Count number of members\n");
	printf(" 13. Show Statistics\n");
	printf(" 99. Quit\n");
}
